...
ANTHROPIC_API_KEY_ENV_VAR_NAME = "ANTHROPIC_API_KEY"
...
PREDEFINED_PROVIDERS = [
    ...
    },
    {
        ...
        "api_key": ANTHROPIC_API_KEY_ENV_VAR_NAME,
    },
]
...
PREDEFINED_PROVIDERS_MODEL_MAP = {
    ...
    OPENROUTER_PROVIDER_NAME: {
        "text": {
            ...
            "inference_parameters": DEFAULT_TEXT_INFERENCE_PARAMS,
        },
        "reasoning": {
    ...
    ANTHROPIC_PROVIDER_NAME: {
        ...
        # No embedding: Anthropic has no public embedding model
    },
}
